...
def _plot_coverage(coverage: pd.DataFrame, path: Path) -> None:
    ...
    fig.text(0.06, 0.01, "Interpret raw topic trends alongside this changing assignment rate; outliers are not a substantive category.", ha="left", color="#475569", fontsize=9)
